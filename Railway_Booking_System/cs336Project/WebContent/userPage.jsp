...
<body style="background: linear-gradient(to right, #d7d2cc 0%, #304352 100%)">
    ...
    <section id="home" class="min-h-100vh flex justify-center items-center">
        <div class="text-center mx-5 md-mx-l5">
            <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900">Hi! Welcome to SAK!</h1>
            <p class="white fs-m1 mt-3">We're currently working hard to bring you the best online booking experience. Please check back soon!</p>
        </div>
    </section>
